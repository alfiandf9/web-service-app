...
if($url == '/karyawan' && $_SERVER['REQUEST_METHOD'] == 'GET') {
...
if($url == '/karyawan' && $_SERVER['REQUEST_METHOD'] == 'POST') {
...
if(preg_match("/karyawan\/([0-9])+/", $url, $matches) && $_SERVER['REQUEST_METHOD'] == 'PUT'){
...
if(preg_match("/karyawan\/([0-9])+/", $url, $matches) && $_SERVER['REQUEST_METHOD'] == 'GET'){
...
if(preg_match("/karyawan\/([0-9])+/", $url, $matches) && $_SERVER['REQUEST_METHOD'] == 'DELETE'){
    $karyawanId = $matches[1];
